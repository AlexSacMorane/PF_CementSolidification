...
def Sort_vtk_IC(dict_user):
    '''
    Sort .vtk files generated by MOOSE.
    '''
    j = 0
    j_str = index_to_str(j)
    filepath = Path('PF_Cement_Solidification_IC_other_'+j_str+'.pvtu')
    while filepath.exists():
        for i_proc in range(dict_user['n_proc']):
            os.rename('PF_Cement_Solidification_IC_other_'+j_str+'_'+str(i_proc)+'.vtu','vtk/PF_Cement_Solidification_IC_other_'+j_str+'_'+str(i_proc)+'.vtu')
        os.rename('PF_Cement_Solidification_IC_other_'+j_str+'.pvtu','vtk/PF_Cement_Solidification_IC_other_'+j_str+'.pvtu')
        j = j + 1
        j_str = index_to_str(j)
        filepath = Path('PF_Cement_Solidification_IC_other_'+j_str+'.pvtu')
